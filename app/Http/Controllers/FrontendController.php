...
class FrontendController extends Controller
{
    public function getHome()
    {
        ...
        $allProducts = VpProduct::orderBy('prod_id', 'desc')->take(9)->get();
        $categories = VpCategory::all(); // Lấy tất cả danh mục
        return view('frontend.home', compact('product_featured', 'product_new', 'allProducts', 'categories'));
    }
    ...
    public function getSearch(Request $request)
    {
        ...
        $prod_search = VpProduct::where('prod_name', 'like', '%' . $keyword . '%')->paginate(6);
